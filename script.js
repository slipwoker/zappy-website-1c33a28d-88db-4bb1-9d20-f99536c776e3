    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אירוח בשדרות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1c33a28d-88db-4bb1-9d20-f99536c776e3',
                    name: data.name || '',
                    email: data.email || '',
